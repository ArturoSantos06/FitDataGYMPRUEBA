  ...
  return (
    <div className="relative">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-4 bg-gray-800 p-6 rounded-xl shadow-xl border border-gray-700 h-fit lg:sticky lg:top-6 z-10">
        ...
        <div className="lg:col-span-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {memberships.map((membership) => (
              <div 
                key={membership.id} 
                className="group w-full aspect-video relative rounded-xl overflow-hidden shadow-2xl transition-transform hover:-translate-y-1 cursor-default bg-black border border-gray-800"
              >
                {membership.image ? (
                    <img 
                ...
                <div className="absolute inset-0 bg-black/80 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-center gap-3 backdrop-blur-sm">
                    ...
                    <div className="flex gap-3 mt-2">
                      <button onClick={() => handleEdit(membership)} className="px-4 py-2 bg-amber-500 text-black font-bold rounded-full hover:bg-amber-400 transition-colors text-sm shadow-lg">
                        Editar
                      </button>
                      <button onClick={() => handleDelete(membership.id)} className="px-4 py-2 bg-red-600 text-white font-bold rounded-full hover:bg-red-500 transition-colors text-sm shadow-lg">
                        Borrar
                      </button>
                    </div>
                </div>
